...
const phases: Phase[] = [
    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: "MCB Juice mobile payment", status: "planned", detail: "420K+ subscribers. Via Mastercard Gateway or Peach Payments" },
          { name: "MauCAS QR payment", status: "planned", detail: "National interoperable QR — all payment apps support it" },
          { name: "Peach Payments gateway", status: "planned", detail: "Single integration: MCB Juice + blink + MauCAS QR + cards. Blocked: SDK access" },
          { name: "Pop (Bank One NFC + QR)", status: "planned", detail: "Tap & Pop contactless via MiPS" },
          { name: "India UPI/RuPay", status: "future", detail: "BoM + RBI linkage for tourist payments" },
        ],
      },
      {
      ...
      {
        id: 7, name: "Staff & Workforce", status: "done",
        features: [
          ...
          { name: "Staff scheduling (weekly planner)", status: "done", detail: "Web console + API, day/week views, copy-week" },
          { name: "Timesheets & payroll reports", status: "done", detail: "Hours worked, days, regular/overtime, late count, CSV export" },
          { name: "Leave management", status: "done", detail: "Leave types, balances, request/approve/reject" },
          { name: "Staff performance leaderboard", status: "done", detail: "v_staff_performance view, 7d/30d/90d toggle" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Webhook framework", status: "done", detail: "Subscriptions, firing, UI, test endpoint" },
          { name: "Open API documentation", status: "planned" },
          { name: "QuickBooks integration", status: "planned", detail: "Phase 4.5 — most popular in Mauritius" },
          { name: "Shopify integration", status: "planned", detail: "Phase 5 — sync products/inventory" },
        ],
      },
      {
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 37.65, name: "Staff & Workforce (Web)", status: "done", features: [
        { name: "Staff Hub dashboard (total staff, shifts, hours)", status: "done", detail: "4 stat cards + performance leaderboard" },
        { name: "Schedule (weekly shift planner)", status: "done", detail: "Drag-drop scheduling with day/week views" },
        { name: "Timesheets (hours & payroll reports)", status: "done", detail: "Hours worked, days, regular/overtime, late count" },
        { name: "Leave management (requests & balances)", status: "done", detail: "Leave types, balances, approve/reject workflow" },
        { name: "Staff performance view", status: "done", detail: "v_staff_performance SQL view, sales_rep_id based" },
        { name: "Shift timezone fix (UTC parsing)", status: "done", detail: "DateUtils.hoursElapsedSinceUtc utility, 11 unit tests" },
      ]},
      { id: 37.66, name: "Web Signup & Marketing Site", status: "done", features: [
        { name: "Customer signup page (/customer/signup)", status: "done", detail: "2-step wizard: account → business details, auto-login, Google Sign-In" },
        { name: "Login page signup link", status: "done", detail: "PortalLoginForm signupHref prop, 'Create one for free' link" },
        { name: "www.posterita.com redesign", status: "done", detail: "Tailwind CSS, real product screenshots, SEO (JSON-LD, OG tags, FAQ schema)" },
        { name: "5-tier regional pricing", status: "done", detail: "Free/$3/$7/$15/$29 with developing/emerging/developed multipliers" },
        { name: "Interactive pricing calculator", status: "done", detail: "Sliders for users/terminals/stores, real-time cost estimate" },
      ]},
      ...
      { id: 38, name: "Mauritius Market Integrations", status: "partial", features: [
        { name: "MRA e-invoicing certification", status: "partial", detail: "Backend code exists (JSON→IFP→IRN+QR). Needs test suite + EBS MRA ID" },
        { name: "CBRIS integration (BRN lookup)", status: "planned", detail: "APIMall REST API, BRN verification for B2B customers/suppliers (Rs 3,800/yr)" },
        { name: "Peach Payments gateway", status: "planned", detail: "Single integration: MCB Juice + blink + MauCAS QR + cards. Blocked: needs SDK" },
        { name: "MauCAS QR payments", status: "planned", detail: "National interoperable QR — every payment app scans same QR" },
        { name: "blink Dynamic QR (POS → device)", status: "partial", detail: "API exists, blink device at Super U. Amount auto-transfers to QR device" },
        { name: "MCB Juice (420K+ subscribers)", status: "planned", detail: "Via MCB Mastercard Gateway (REST-JSON) or Peach Payments" },
        { name: "Pop (Bank One NFC + QR)", status: "planned", detail: "Tap & Pop contactless via MiPS PayStation" },
        { name: "MyT Money (Mauritius Telecom)", status: "planned", detail: "MauCAS-compatible wallet" },
        { name: "QuickBooks Online", status: "planned", detail: "Most popular accounting in Mauritius (Quick Focus Ltd reseller)" },
        { name: "CSG/NSF/PAYE payroll export", status: "planned", detail: "Monthly MRA return from staff data. CSG + NSF 2.5% + Training Levy 1.5%" },
        { name: "Data Protection DPA 2017 audit", status: "planned", detail: "GDPR-aligned: consent, retention, breach notification" },
        { name: "India UPI/RuPay", status: "future", detail: "Indian tourist payments at Mauritius merchants (BoM + RBI linkage)" },
        { name: "TradeNet (Customs EDI)", status: "future", detail: "Import declarations, duty calc — wholesale/distribution only" },
        { name: "Local delivery APIs (Bongeni, NU Livrer)", status: "future", detail: "Last-mile delivery — fragmented market, no dominant API" },
      ]},
      { id: 39, name: "Self-Checkout & Future", status: "future", features: [
        { name: "Customer-facing checkout UI", status: "future", detail: "terminal_type = self_service" },
        ...
        { name: "Google Sign-In", status: "done", detail: "Supabase OAuth, on customer login page" },
        { name: "Shopify integration", status: "planned", detail: "Sync products/inventory between POS and online store" },
        { name: "eShops.mu marketplace", status: "future", detail: "Mauritius multi-vendor digital mall" },
        { name: "Franchise analytics", status: "future", detail: "Cross-brand reporting, benchmarking" },
      ]},
    ],
  },
];
