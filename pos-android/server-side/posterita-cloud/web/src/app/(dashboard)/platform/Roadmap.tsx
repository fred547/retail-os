    ...
    modules: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Stock deduction on sale", status: "planned", detail: "Auto-decrement qty when order completes" },
          { name: "Expiry & batch tracking", status: "planned", detail: "Track expiry dates, batch/lot numbers" },
          { name: "Low stock alerts & reorder points", status: "planned" },
          { name: "Stock transfer between stores", status: "future" },
        ],
      },
      {
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Shift clock in/out", status: "planned", detail: "Time tracking, timesheet reports" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Z-report / daily summary", status: "planned", detail: "End-of-day totals by payment type, tax, discounts, voids" },
          { name: "Sales analytics (trends, best sellers)", status: "planned" },
          { name: "Export to CSV/Excel", status: "planned" },
        ],
      },
      {
